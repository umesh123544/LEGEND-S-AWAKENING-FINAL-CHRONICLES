...
export const PORTRAIT_SLOTS: { key: PortraitKey; label: string; hint: string; defaultPrompt: string; removeBackground: boolean; inputMode: 'actions' | 'upload' | 'prompt' }[] = [
  { key: 'hero', label: 'Ram', hint: 'The hero, Prince of Ayodhya — used in the battle world, HUD, menu and dialogue.', defaultPrompt: 'Prince Ram from Ramayana, blue skin, royal warrior with bow and arrow, crown, traditional Indian attire, full body, heroic pose, game character concept art, solid plain white studio background, no scenery, no props behind character', removeBackground: true, inputMode: 'actions' },
  { key: 'villain', label: 'Ravan', hint: 'The demon king of Lanka, final boss — used in the battle world, menu and dialogue.', defaultPrompt: 'Ravan the ten-headed demon king from Ramayana, dark menacing rakshasa king, crown, multiple arms holding weapons, fierce expression, full body, game character concept art, solid plain white studio background, no scenery, no props behind character', removeBackground: true, inputMode: 'actions' },
  { key: 'enemy_dark_soldier', label: 'Enemy: Rakshasa Soldier', hint: "Common enemy in Ravan's army.", defaultPrompt: 'rakshasa demon soldier warrior, dark skin, ancient armor, holding a sword, full body, game character concept art, solid plain white studio background, no scenery, no props behind character', removeBackground: true, inputMode: 'actions' },
  { key: 'enemy_shadow_archer', label: 'Enemy: Rakshasa Archer', hint: "Ranged enemy in Ravan's army.", defaultPrompt: 'rakshasa demon archer, dark warrior holding a bow, ancient armor, full body, game character concept art, solid plain white studio background, no scenery, no props behind character', removeBackground: true, inputMode: 'actions' },
  { key: 'enemy_aura_hunter', label: 'Enemy: Rakshasa Hunter', hint: "Scout enemy in Ravan's army.", defaultPrompt: 'agile rakshasa demon hunter, dark warrior with twin daggers, full body, game character concept art, solid plain white studio background, no scenery, no props behind character', removeBackground: true, inputMode: 'actions' },
  { key: 'enemy_dark_guardian', label: 'Enemy: Rakshasa Guardian', hint: "Tanky enemy guarding Lanka.", defaultPrompt: 'heavy rakshasa demon guardian, huge mace, bulky ancient armor, full body, game character concept art, solid plain white studio background, no scenery, no props behind character', removeBackground: true, inputMode: 'actions' },
  { key: 'enemy_demon_beast', label: 'Enemy: Asura Beast', hint: "Monster enemy from the underworld.", defaultPrompt: 'asura demon beast monster, clawed, menacing, mythological Indian demon creature, full body, game character concept art, solid plain white studio background, no scenery, no props behind character', removeBackground: true, inputMode: 'actions' },
  { key: 'enemy_mini_boss', label: 'Enemy: Rakshasa General', hint: "Mini-boss commanding Ravan's forces.", defaultPrompt: 'powerful rakshasa general, ornate dark ancient armor, multiple weapons, imposing, full body, game character concept art, solid plain white studio background, no scenery, no props behind character', removeBackground: true, inputMode: 'actions' },
  { key: 'aura', label: 'Hanuman (Companion)', hint: 'The loyal Vanara devotee who guides Ram — shown in dialogue.', defaultPrompt: 'Hanuman the monkey god, orange fur, warrior devotee, mythological Indian character portrait, game concept art', removeBackground: false, inputMode: 'prompt' },
  { key: 'npc', label: 'Side Character (Lakshman/Jatayu)', hint: 'Shown in dialogue for Lakshman, Jatayu, and other allies.', defaultPrompt: 'Lakshman, loyal brother warrior prince, traditional Indian royal attire, portrait, game concept art', removeBackground: false, inputMode: 'prompt' },
  { key: 'sita', label: 'Sita', hint: 'Ram\'s wife, held captive by Ravan — shown in dialogue and the rescue reveal.', defaultPrompt: 'Sita, Indian princess, graceful, traditional royal saree, portrait, game concept art', removeBackground: false, inputMode: 'prompt' },
  { key: 'background', label: 'Battle Background / Location', hint: 'Backdrop shown behind the battle world.', defaultPrompt: 'ancient Indian mythological forest and golden palace of Lanka, dramatic lighting, wide background concept art', removeBackground: false, inputMode: 'upload' },
];
